 ...
 */
export function worldToGrid(position: Vector3, gridSize = 10): { x: number; y: number; z: number } {
  return {
 ...
 */
export function gridToWorld(gridX: number, gridY: number, gridZ: number, gridSize = 10): Vector3 {
